...
public interface IAdvertisementRepository
{
    ...
    /// <param name="cancellation"></param>
    /// <returns></returns>
    Task<IReadOnlyCollection<AdvertisementDto>> GetWhere(int skip, int take, string? query, Guid? categoryId, string? city, decimal? fromPrice, decimal? toPrice, CancellationToken cancellation);
