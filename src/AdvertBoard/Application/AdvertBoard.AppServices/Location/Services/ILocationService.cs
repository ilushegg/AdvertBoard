...
namespace AdvertBoard.AppServices.Location.Services
{
    ...
    {
        Guid Add(string country, string city, string street, string number, CancellationToken cancellation);
        Task<Guid> AddAsync(string country, string city, string street, string number, CancellationToken cancellation);
